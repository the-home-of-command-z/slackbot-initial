...
classifierAction.addDocument(['on', 'lights'], 'light_on')
...
classifierAction.addDocument(['off', 'lights'], 'light_off')
classifierAction.addDocument(['off', 'light'], 'light_off')
classifierAction.addDocument(['off', 'lights'], 'light_off')
classifierAction.addDocument(['off', 'light'], 'light_off')
classifierAction.addDocument(['off', 'lights'], 'light_off')
classifierAction.addDocument(['off', 'light'], 'light_off')
...
classifierAction.addDocument(['silence', 'volume'], 'volume_mute')
classifierAction.addDocument(['stop', 'all', 'sound'], 'volume_mute')
classifierAction.addDocument(['mute', 'silence'], 'volume_mute')
...
classifierAction.addDocument(['light', 'status'], 'light_status')
classifierAction.addDocument(['status'], 'light_status')
classifierAction.addDocument(['status'], 'light_status')
classifierAction.addDocument(['status'], 'light_status')
classifierAction.addDocument(['state'], 'light_status')
classifierAction.addDocument(['state'], 'light_status')
...
classifierAction.addDocument(['make', 'red'], 'light_red')
classifierAction.addDocument(['red'], 'light_red')
classifierAction.addDocument(['make', 'red'], 'light_red')
classifierAction.addDocument(['red'], 'light_red')
classifierAction.addDocument(['make', 'red'], 'light_red')
...
classifierAction.addDocument(['make', 'green'], 'light_green')
classifierAction.addDocument(['green'], 'light_green')
classifierAction.addDocument(['make', 'green'], 'light_green')
classifierAction.addDocument(['green'], 'light_green')
classifierAction.addDocument(['make', 'green'], 'light_green')
...
classifierAction.addDocument(['make', 'blue'], 'light_blue')
classifierAction.addDocument(['blue'], 'light_blue')
classifierAction.addDocument(['make', 'blue'], 'light_blue')
classifierAction.addDocument(['blue'], 'light_blue')
classifierAction.addDocument(['make', 'blue'], 'light_blue')
...
classifierAction.save('simpleArray2.json', function (err, classifier) {
  if (err) {
    console.log(err)
  }
})
